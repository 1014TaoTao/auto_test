...
class UserBehavior(TaskSet):
    ...
    def test2(self):
        try:
            case_name = YamlPack().test_data()[1]['name']
            method = YamlPack().test_data()[1]['method']
            url = YamlPack().test_data()[1]['url']
            headers = YamlPack().test_data()[1]['headers']
            data = YamlPack().test_data()[1]['data']
            # status_code = YamlPack().test_data()[1]['expected']['status_code']
            # code = YamlPack().test_data()[1]['expected']['code']
            msg = YamlPack().test_data()[1]['expected']['msg']
...
if __name__ == '__main__':
    ...
    os.system(f"locust -f locust_demo.py --host={Config(setting.CONFIG_INI).apihost_43_13} --web-host=127.0.0.1 --web-port=8089")
    ...
    # os.system(f"locust --config={setting.locust_conf_path}")
