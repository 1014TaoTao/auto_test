...
from tools.common_tools.api_tool_open_html import OpenHtml
...
class UiApiAutoTool(object):
    ...
    def runAll_info(self, ENVIRONMENT, TESTER, DELETE_ON_OFF, SAVE_ON_OFF, EMAIL_ON_OFF, OPEN_REPORY_ON_OFF,
        ...
        try:
            if DELETE_ON_OFF == 'on':
                ...
                A.delete_old_file(
                    ...
                    REPORT_RESULT_PATH=setting.API_REPORT_RESULT_PATH
                )
            else:
        ...
        # 执行测试
        A.run_test(log_path=setting.API_LOG_PATH)
        ...
        try:
            if SAVE_ON_OFF == 'on':
                ...
                A.run_allure_report(
                    ...
                    REPORT_HISTORY_PATH=setting.API_REPORT_HISTORY_PATH,
                    RESULT_HISTORY_PATH=setting.API_RESULT_HISTORY_PATH,
                    StartEnvironmentFilePath=setting.API_StartEnvironmentFilePath,
                    EndEnvironmentFile=setting.API_EndEnvironmentFile,
                    StartEnvironmentFileXMLPath=setting.API_StartEnvironmentFileXMLPath,
                    EndEnvironmentXMLFile=setting.API_EndEnvironmentXMLFile,
                    StartExcutorJson=setting.API_StartExcutorJson,
                    EndExcutorJson=setting.API_EndExcutorJson
                )
            else:
        ...
        try:
            if EMAIL_ON_OFF == 'on':
                ...
                A.run_email(
                    REPORT_END_PATH=setting.API_REPORT_END_PATH,
                    dirpath=setting.API_REPORT_END_PATH,
                    outFullName=setting.API_FILE_LIST_PATH,
                    log_path=setting.API_LOG_PATH,
        ...
        try:
            if OPEN_REPORY_ON_OFF == 'on':
                ...
                A.open_report(
                    log_path=setting.API_LOG_PATH,
                    REPORT_END_PATH=setting.API_REPORT_RESULT_PATH
                )
            else:
