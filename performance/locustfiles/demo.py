...
from locust import User,task, TaskSet, events, HttpUser,FastHttpUser  # SequentialTaskSet有序执行、TaskSet无序执行
...
class WebsiteTask(FastHttpUser):
    index = 0
    ...
    def query_pipeline(self):
        ...
        try:
            ...
            with self.client.request(method=method, path=base_url, json=data, headers=headers,
